...
latex_documents = [
    (master_doc, 'dhcpcanon.tex', u'dhcpcanon Documentation',
     u'juga', 'manual'),
]
...
man_pages = [
    (master_doc, 'dhcpcanon', u'dhcpcanon Documentation',
     [author], 1)
]
